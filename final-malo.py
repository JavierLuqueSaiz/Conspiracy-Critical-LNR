...
bbw_en = vectorizer.fit_transform(preprocess(X))
...
# vectorizer = CountVectorizer(binary=True)
# new_roberta_es = vectorizer.fit_transform(preprocess(X_es))
# new_roberta_es_test = vectorizer.transform(preprocess(X_es_test))
...
predicted_es = ensemble_es.predict(new_roberta_es_test)
...
predicted_en = ensemble_es.predict(bbw_en_test)
...
predictions_df_es["majority_vote"] = predicted_es
predictions_df_en["majority_vote"] = predicted_en
